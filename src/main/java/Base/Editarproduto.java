...
public class Editarproduto extends JFrame {
	...
	public JTextField Txtobs;
		...
		// Adicione um novo construtor que recebe os dados do produto como parâmetros


		public void Editarproduto() { //???????? tu tem duas funçoes com o mesmo nome?
	    ...
	    private void initComponents(Object[] produtoData) {
	       ...
	       Txtid.setText(produtoData[0].toString());
